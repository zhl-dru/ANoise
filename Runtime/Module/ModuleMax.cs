...
namespace ANoise
{
    public class ModuleMax : ModuleBase
    {
        private ModuleBase m_source1;
        private ModuleBase m_source2;
        private FunctionPointer<algorithm_a2> m_max_fun_ptr;

        public ModuleMax SetSource1(ModuleBase source1) { m_source1 = source1; return this; }
        public ModuleMax SetSource2(ModuleBase source2) { m_source2 = source2; return this; }
        public ModuleMax SetSource1(double source1) { m_source1 = new ModuleConstant().SetValue(source1).Build(); return this; }
        public ModuleMax SetSource2(double source2) { m_source2 = new ModuleConstant().SetValue(source2).Build(); return this; }
        public ModuleMax Build()
        {
            unsafe { m_max_fun_ptr = BurstCompiler.CompileFunctionPointer<algorithm_a2>(amath.max); }
            return this;
        }
        ...
        public override JobHandle Get(NativeArray<double2> inputs, NativeArray<double> outputs, JobHandle dependsOn = default)
        {
            ...
            var job = AlgorithmA2Job.JobHandle(cache1, cache2, outputs, m_max_fun_ptr, source2job);
