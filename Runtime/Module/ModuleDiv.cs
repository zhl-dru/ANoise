...
namespace ANoise
{
    public class ModuleDiv : ModuleBase
    {
        private ModuleBase m_source1;
        private ModuleBase m_source2;
        private FunctionPointer<algorithm_a2> m_div_fun_ptr;

        public ModuleDiv SetSource1(ModuleBase source1) { m_source1 = source1; return this; }
        public ModuleDiv SetSource2(ModuleBase source2) { m_source2 = source2; return this; }
        public ModuleDiv SetSource1(double source1) { m_source1 = new ModuleConstant().SetValue(source1).Build(); return this; }
        public ModuleDiv SetSource2(double source2) { m_source2 = new ModuleConstant().SetValue(source2).Build(); return this; }
        public ModuleDiv Build()
        {
            unsafe { m_div_fun_ptr = BurstCompiler.CompileFunctionPointer<algorithm_a2>(amath.div); }
            return this;
        }
        ...
        public override JobHandle Get(NativeArray<double2> inputs, NativeArray<double> outputs, JobHandle dependsOn = default)
        {
            ...
            var job = AlgorithmA2Job.JobHandle(cache1, cache2, outputs, m_div_fun_ptr, source2job);
