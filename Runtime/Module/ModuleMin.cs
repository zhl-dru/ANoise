...
namespace ANoise
{
    public class ModuleMin : ModuleBase
    {
        private ModuleBase m_source1;
        private ModuleBase m_source2;
        private FunctionPointer<algorithm_a2> m_min_fun_ptr;

        public ModuleMin SetSource1(ModuleBase source1) { m_source1 = source1; return this; }
        public ModuleMin SetSource2(ModuleBase source2) { m_source2 = source2; return this; }
        public ModuleMin SetSource1(double source1) { m_source1 = new ModuleConstant().SetValue(source1).Build(); return this; }
        public ModuleMin SetSource2(double source2) { m_source2 = new ModuleConstant().SetValue(source2).Build(); return this; }
        public ModuleMin Build()
        {
            unsafe { m_min_fun_ptr = BurstCompiler.CompileFunctionPointer<algorithm_a2>(amath.min); }
            return this;
        }
        ...
        public override JobHandle Get(NativeArray<double2> inputs, NativeArray<double> outputs, JobHandle dependsOn = default)
        {
            ...
            var job = AlgorithmA2Job.JobHandle(cache1, cache2, outputs, m_min_fun_ptr, source2job);
